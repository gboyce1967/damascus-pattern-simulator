...
export default function App() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-b from-[#07070b] via-[#0b0b10] to-black p-5">
      <div className="h-full grid grid-cols-[340px_1fr_340px] gap-4">
        <Sidebar
          ready={ready}
          sessionId={sessionId}
        ...
        <div className="flex flex-col gap-4 min-h-0">
          <div className="glass p-4 flex flex-col min-h-0 flex-1">
